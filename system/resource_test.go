...
func TestCreateMapping1(t *testing.T) {
	res := struct {
		ID     core.ID     `json:"id1" vyze:"id"`
		Name   string      `json:"name1" vyze:"name"`
		IDs    core.IDList `json:"ids" vyze:"id,relation"`
...
func TestWriteReadResource3(t *testing.T) {
	...
	type ts struct {
		ID      *core.ID   `vyze:"id" json:"id"`
		IDs1    []core.ID  `vyze:"id,rel5" json:"ids1"`
		IDs2    []*core.ID `vyze:"id,rel6" json:"ids2"`
		Name    string     `vyze:"name" json:"name"`
