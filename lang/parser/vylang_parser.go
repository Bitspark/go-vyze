...
func vylangParserInit() {
	...
	staticData.serializedATN = []int32{
		4, 1, 29, 186, 2, 0, 7, 0, 2, 1, 7, 1, 2, 2, 7, 2, 2, 3, 7, 3, 2, 4, 7,
		...
		18, 20, 22, 24, 26, 28, 30, 32, 34, 36, 0, 1, 1, 0, 5, 15, 191, 0, 41,
		...
		1, 0, 0, 0, 38, 40, 5, 27, 0, 0, 39, 38, 1, 0, 0, 0, 40, 43, 1, 0, 0, 0,
		41, 39, 1, 0, 0, 0, 41, 42, 1, 0, 0, 0, 42, 59, 1, 0, 0, 0, 43, 41, 1,
		0, 0, 0, 44, 46, 5, 27, 0, 0, 45, 44, 1, 0, 0, 0, 46, 49, 1, 0, 0, 0, 47,
		45, 1, 0, 0, 0, 47, 48, 1, 0, 0, 0, 48, 50, 1, 0, 0, 0, 49, 47, 1, 0, 0,
		0, 50, 54, 3, 2, 1, 0, 51, 53, 5, 27, 0, 0, 52, 51, 1, 0, 0, 0, 53, 56,
		...
		88, 11, 1, 0, 0, 0, 89, 90, 5, 26, 0, 0, 90, 91, 5, 4, 0, 0, 91, 92, 3,
		...
		1, 0, 0, 0, 132, 134, 1, 0, 0, 0, 133, 135, 5, 27, 0, 0, 134, 133, 1, 0,
		0, 0, 134, 135, 1, 0, 0, 0, 135, 136, 1, 0, 0, 0, 136, 137, 5, 18, 0, 0,
		137, 25, 1, 0, 0, 0, 138, 141, 3, 12, 6, 0, 139, 141, 3, 10, 5, 0, 140,
		138, 1, 0, 0, 0, 140, 139, 1, 0, 0, 0, 141, 27, 1, 0, 0, 0, 142, 143, 5,
		19, 0, 0, 143, 144, 5, 20, 0, 0, 144, 29, 1, 0, 0, 0, 145, 154, 5, 26,
		0, 0, 146, 151, 3, 34, 17, 0, 147, 149, 5, 21, 0, 0, 148, 150, 5, 26, 0,
		0, 149, 148, 1, 0, 0, 0, 149, 150, 1, 0, 0, 0, 150, 152, 1, 0, 0, 0, 151,
		147, 1, 0, 0, 0, 151, 152, 1, 0, 0, 0, 152, 154, 1, 0, 0, 0, 153, 145,
		1, 0, 0, 0, 153, 146, 1, 0, 0, 0, 154, 31, 1, 0, 0, 0, 155, 166, 5, 26,
		0, 0, 156, 157, 3, 34, 17, 0, 157, 158, 5, 22, 0, 0, 158, 163, 5, 26, 0,
		0, 159, 161, 5, 21, 0, 0, 160, 162, 5, 26, 0, 0, 161, 160, 1, 0, 0, 0,
		161, 162, 1, 0, 0, 0, 162, 164, 1, 0, 0, 0, 163, 159, 1, 0, 0, 0, 163,
		164, 1, 0, 0, 0, 164, 166, 1, 0, 0, 0, 165, 155, 1, 0, 0, 0, 165, 156,
		1, 0, 0, 0, 166, 33, 1, 0, 0, 0, 167, 172, 5, 26, 0, 0, 168, 169, 5, 23,
		0, 0, 169, 171, 5, 26, 0, 0, 170, 168, 1, 0, 0, 0, 171, 174, 1, 0, 0, 0,
		172, 170, 1, 0, 0, 0, 172, 173, 1, 0, 0, 0, 173, 35, 1, 0, 0, 0, 174, 172,
		1, 0, 0, 0, 175, 184, 5, 27, 0, 0, 176, 178, 5, 27, 0, 0, 177, 176, 1,
		0, 0, 0, 177, 178, 1, 0, 0, 0, 178, 179, 1, 0, 0, 0, 179, 181, 5, 24, 0,
		0, 180, 182, 5, 27, 0, 0, 181, 180, 1, 0, 0, 0, 181, 182, 1, 0, 0, 0, 182,
...
const (
	...
	VyLangParserSTRING     = 25
	VyLangParserIDENT      = 26
	VyLangParserNL         = 27
	VyLangParserWHITESPACE = 28
	VyLangParserDIGITS     = 29
)
...
func (p *VyLangParser) Pipe() (localctx IPipeContext) {
	...
	case VyLangParserT__4, VyLangParserT__5, VyLangParserT__6, VyLangParserT__7, VyLangParserT__8, VyLangParserT__9, VyLangParserT__10, VyLangParserT__11, VyLangParserT__12, VyLangParserT__13, VyLangParserT__14, VyLangParserT__15, VyLangParserIDENT:
		p.EnterOuterAlt(localctx, 1)
		{
			p.SetState(81)
			p.PipeProperty()
...
func (p *VyLangParser) PipeProperty() (localctx IPipePropertyContext) {
	...
	switch p.GetTokenStream().LA(1) {
	case VyLangParserT__4, VyLangParserT__5, VyLangParserT__6, VyLangParserT__7, VyLangParserT__8, VyLangParserT__9, VyLangParserT__10, VyLangParserT__11, VyLangParserT__12, VyLangParserT__13, VyLangParserT__14:
		p.EnterOuterAlt(localctx, 1)
		{
			p.SetState(85)
			p.PipeTerminal()
	...
	case VyLangParserT__15, VyLangParserIDENT:
		p.EnterOuterAlt(localctx, 2)
		{
			p.SetState(86)
			p.PipeField()
...
func (p *VyLangParser) PipeMap() (localctx IPipeMapContext) {
	...
	if (int64(_la) & ^0x3f) == 0 && ((int64(1)<<_la)&67239904) != 0 {
		{
			p.SetState(122)
			p.PipeMapEntry()
		}
